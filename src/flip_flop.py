...
def run_fastCA(initial_state, steps, steps_per_gen, params=default_params, update_progress = False):
...
def stream_number_progression(width, height, ground_height, num_steps, noise_amplitude, seed):
    np.random.seed(seed)
